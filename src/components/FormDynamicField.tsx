...
import { FormControl, InputLabel, FormHelperText, TextField, Stack, MenuItem, Select, IconButton, Grid, Button } from '@mui/material';
...
export default function FormDynamicField({ data, fields, setRowReference, handleChangeMultiple = () => {}, is_disabled, errors }: Props): React.ReactNode {
                ...
                return (
                    ...
                    >
                        <DatePicker
                            ...
                            onChange={(date) => {
                                const formattedDate: string = date ? dayjs(date).format("YYYY-MM-DD") : ""; // Ensure format
    ...
    const btnDeleteRow = (index: number): React.ReactNode | null => {
        const btn: React.ReactNode | null = (!is_disabled)
    ...
    const btnAddRow: React.ReactNode | null = (!is_disabled)
