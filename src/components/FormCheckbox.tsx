...
import { FormControl, FormLabel, FormHelperText, TextField, Stack, FormGroup, FormControlLabel, Checkbox } from '@mui/material';
...
export default function FormCheckbox({ question_label, labels, data, handleChange = () => {}, field_name, is_disabled, is_required, has_others=false, errors }: Props): React.ReactNode {
